								...
								<table class="table table-bordered" id="datatable" >
									...
									while($z1=mysql_fetch_array($z))
									{
										...
										while($z3=mysql_fetch_array($z2))
										{
											...
											$y=mysql_fetch_array(mysql_query("select * from blog where session='$z3[email]' and status='1'"));
											$y1=mysql_query("select * from blog where session='$z3[email]' and status='1'");
									...
									?>
										...
										<tr class="odd gradeX">
											...
											{?>
                                            <a href="index.php?k1=viewblog&k2=<?php echo $z1['email'];?>"><button type="button" class="btn btn-primary btn-rad">View Blog</button></a>
                                            <?php
											}
											else
											{
												?>
												<button type="button" class="btn btn-info btn-rad">No Blog</button>
                                                <?php
											}
											?>
                                            </td>
