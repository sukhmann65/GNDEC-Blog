        ...
        <div class="block-flat">
          ...
          <div class="content">
			  ...
			  <div class="form-group">
                ...
                <label>Field marked with asterisk (<span style="color:#cc0000;">*</span>) is mandatory.</label>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="hidden" name="k1" value="v_blog">
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <button class="btn btn-default"><a href="user_clear.php?k=vblog">Cancel</a></button>
