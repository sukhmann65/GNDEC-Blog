          ...
          <div class="content"><span style="margin-left:650px;">Fields marked with asterisk (<span style="color:#cc0000;">*</span>) are mandatory.</span>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="hidden" name="k1" value="syn_record">
                  <input type="hidden" name="h" value="synopsis_record">
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <button class="btn btn-default"><a href="user_clear.php?k=g_syn">Cancel</a></button>
                </div>
              </div>
            </form>
          </div>
