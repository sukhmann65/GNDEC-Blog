...
$y=mysql_fetch_array(mysql_query("select * from code where sno='$id' and status='1'"));
...
<div class="col-md-12">
        ...
        <div class="block-flat">
          ...
          <div class="content"><span style="margin-left:650px;">Fields marked with asterisk (<span style="color:#cc0000;">*</span>) are mandatory.</span>
              ...
              <div class="form-group" >
				...
				?>
                  <select class="form-control <?php if($_SESSION['palert']){echo "parsley-error";}?>" name="proj">
              ...
              <div class="form-group">
				...
				if($id)
				{
					...
					{
				?>
                  <input type="text" name="guide" class="form-control <?php if($_SESSION['galert']){echo "parsley-error";}?>" /> 
				  <?php 
				  }
				  ?>
                  <span style="color:#cc0000; font-size:13px; font-weight:200; line-height:21px; box-sizing:border-box; font-family:'Open Sans', sans-serif;">
              ...
              <div class="form-group">
                ...
                <span>Upload zip or rar file.</span>
              </div>
                                    
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="hidden" name="h1" value="s_code">
                  <input type="hidden" name="h2" value="<?php echo $id; ?>">
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <button class="btn btn-default"><a href="user_clear.php?k=s_code">Cancel</a></button>
                </div>
              </div>
            </form>
          </div>
      ...
      <?php include_once("user tables/tcode.php"); ?>
    </div>	
