...
<div class="col-md-12">
        ...
        <div class="block-flat">
          ...
          <div class="content"><span style="margin-left:650px;">Field marked with asterisk (<span style="color:#cc0000;">*</span>) is mandatory.</span>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <input type="hidden" name="k1" value="view_proj">
                  <input type="hidden" name="h" value="project">
                  <button type="submit" class="btn btn-primary">Submit</button>
                  <button class="btn btn-default"><a href="user_clear.php?k=proj">Cancel</a></button>
                </div>
              </div>
            </form>
          </div>
